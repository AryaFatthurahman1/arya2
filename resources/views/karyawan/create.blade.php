...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-1">Isi formulir berikut untuk menambah karyawan</p>
</div>
        ...
        <form method="POST" action="{{ route('karyawan.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input id="nik" name="nik" type="text" required class="input-field mt-1" value="{{ old('nik') }}">
                    @error('nik')
                ...
                <div>
                    ...
                    <input id="nama_lengkap" name="nama_lengkap" type="text" required class="input-field mt-1" value="{{ old('nama_lengkap') }}">
                    @error('nama_lengkap')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input id="tempat_lahir" name="tempat_lahir" type="text" required class="input-field mt-1" value="{{ old('tempat_lahir') }}">
                    @error('tempat_lahir')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input id="tanggal_lahir" name="tanggal_lahir" type="date" required class="input-field mt-1" value="{{ old('tanggal_lahir') }}">
                    @error('tanggal_lahir')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="agama" name="agama" type="text" required class="input-field mt-1" value="{{ old('agama') }}">
                    @error('agama')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="telepon" name="telepon" type="text" required class="input-field mt-1" value="{{ old('telepon') }}">
                    @error('telepon')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div class="md:col-span-2">
                    ...
                    <textarea id="alamat" name="alamat" rows="3" required class="input-field mt-1">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select id="satuan_kerja_id" name="satuan_kerja_id" required class="input-field mt-1">
                        ...
                        @foreach (\App\Models\SatuanKerja::all() as $satuan)
                            <option value="{{ $satuan->id }}" {{ old('satuan_kerja_id') == $satuan->id ? 'selected' : '' }}>{{ $satuan->nama_satuan_kerja }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input id="tanggal_masuk" name="tanggal_masuk" type="date" required class="input-field mt-1" value="{{ old('tanggal_masuk') }}">
                    @error('tanggal_masuk')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="nama_bank" name="nama_bank" type="text" class="input-field mt-1" value="{{ old('nama_bank') }}">
                </div>
                <div>
                    <label for="nomor_rekening" class="block text-sm font-medium text-gray-700">Nomor Rekening</label>
                    <input id="nomor_rekening" name="nomor_rekening" type="text" class="input-field mt-1" value="{{ old('nomor_rekening') }}">
                </div>
                <div>
