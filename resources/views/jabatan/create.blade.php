...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-1">Isi formulir berikut untuk menambah jabatan</p>
</div>
        ...
        <form method="POST" action="{{ route('jabatan.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input id="nama_jabatan" name="nama_jabatan" type="text" required class="input-field mt-1" value="{{ old('nama_jabatan') }}">
                ...
                <div>
                    ...
                    <input id="gaji_pokok" name="gaji_pokok" type="number" step="0.01" required class="input-field mt-1" value="{{ old('gaji_pokok') }}">
                ...
                <div>
                    ...
                    <input id="tunjangan_jabatan" name="tunjangan_jabatan" type="number" step="0.01" required class="input-field mt-1" value="{{ old('tunjangan_jabatan') }}">
                ...
                <div>
                    ...
                    <input id="tunjangan_transport" name="tunjangan_transport" type="number" step="0.01" required class="input-field mt-1" value="{{ old('tunjangan_transport') }}">
                ...
                <div>
                    ...
                    <input id="tunjangan_makan" name="tunjangan_makan" type="number" step="0.01" required class="input-field mt-1" value="{{ old('tunjangan_makan') }}">
